...
//script.js에 코드 검증하는 부분 작성해둡니다. -> main은 script2.js에서 확인

let list = ['abc', 123, true, false, 'ABC'];
list.sort();

console.log(list); // ['abc', 123, true, false, 'ABC']
// 결과값을 확인했을 때, 숫자1이 가장 작고, 숫자 t가 가장 크다고 정리됩니다.
...
//이상의 특징 떄문에 1,11,2 와 같은 방식으로 정렬이 이루어집니다. 
