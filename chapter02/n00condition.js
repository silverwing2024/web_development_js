// if (true) console.log("사실"); //제가 잘 작성하는 방식은 아닌데 실행문이 한 줄이면 {}를 생략가능합니다. 
// if (false) {
//   console.log("거짓");
//  } //제가 잘 작성하는 방식은 아닌데 실행문이 한 줄이면 {}를 생략가능합니다. 

 //이상의 코드의 경우 겅의 사용되지 않습니다. 
...
//이상의 코드는 boolean 값을 변수에 대입하여 분기를 조절 할 수 있습니다. 
//11번 라인은 open으로 실행된데 반해, 15번 라인은 동일하게 open 변수임에도 실행되지 않는다는 점에서 분기를 조절 가능합니다. 

//true를 반환하는코드 혹은 false를 반환하는 코드
// let n=1;
// if(n>0){
//   //코드: 조건식
//   console.log("자연수입니다. ");
